...
static const riscv_extra_ext_flag_table_t riscv_extra_ext_flag_table[] =
{
  ...
  RISCV_EXT_FLAG_ENTRY ("xarcvvdsp", x_riscv_isa_flags, MASK_FULL_V),
  RISCV_EXT_FLAG_ENTRY ("xarcvvdsp", x_riscv_isa_flags, MASK_VECTOR),
  RISCV_EXT_FLAG_ENTRY ("xarcvvcplx", x_riscv_xarcv_subext, MASK_XARCVVCPLX),
  RISCV_EXT_FLAG_ENTRY ("xarcvvcplx", x_riscv_isa_flags, MASK_FULL_V),
  RISCV_EXT_FLAG_ENTRY ("xarcvvcplx", x_riscv_isa_flags, MASK_VECTOR),
  RISCV_EXT_FLAG_ENTRY ("xarcvvsad", x_riscv_xarcv_subext, MASK_XARCVVSAD),
  RISCV_EXT_FLAG_ENTRY ("xarcvvsad", x_riscv_isa_flags, MASK_FULL_V),
  RISCV_EXT_FLAG_ENTRY ("xarcvvsad", x_riscv_isa_flags, MASK_VECTOR),
  RISCV_EXT_FLAG_ENTRY ("xarcvmxmb", x_riscv_xarcv_subext, MASK_XARCVMXMB),
  RISCV_EXT_FLAG_ENTRY ("xarcvmxmb", x_riscv_isa_flags, MASK_FULL_V),
  RISCV_EXT_FLAG_ENTRY ("xarcvmxmb", x_riscv_isa_flags, MASK_VECTOR),
  RISCV_EXT_FLAG_ENTRY ("xarcvmxmc", x_riscv_xarcv_subext, MASK_XARCVMXMC),
  RISCV_EXT_FLAG_ENTRY ("xarcvmxmc", x_riscv_isa_flags, MASK_FULL_V),
  RISCV_EXT_FLAG_ENTRY ("xarcvmxmc", x_riscv_isa_flags, MASK_VECTOR),
