...
static const struct riscv_tune_param arcv_rmx500_tune_info = {
  {COSTS_N_INSNS (4), COSTS_N_INSNS (64)},	/* fp_add */
  {COSTS_N_INSNS (4), COSTS_N_INSNS (75)},	/* fp_mul */
  {COSTS_N_INSNS (20), COSTS_N_INSNS (120)},	/* fp_div */
  {COSTS_N_INSNS (4), COSTS_N_INSNS (4)},	/* int_mul */
  {COSTS_N_INSNS (27), COSTS_N_INSNS (87)},	/* int_div */
  4,						/* issue_rate */
  9,						/* branch_cost */
  2,						/* memory_cost */
  8,						/* fmv_cost */
