...
(define_insn "riscv_arcv_apex_void_ftype_v"
  ...
  ""
{
  return xasprintf ("%s # XD (volatile): insn",
  ...
  ""
{
  ...
  {
    case 0:
      return xasprintf ("%s\t%d # XI (volatile): insn src0",
			arcv_apex_asm_mnemonic (operands[0], true),
			(int) INTVAL (operands[1]));
    case 1:
      return xasprintf ("%s\t%s # XD (volatile): insn src0",
			arcv_apex_asm_mnemonic (operands[0], false),
  ...
  ""
{
  ...
  {
    case 0:
      return xasprintf ("%s\t%s,%d # XS (volatile): insn src0, src1",
			arcv_apex_asm_mnemonic (operands[0], true),
			reg_names[REGNO (operands[1])],
			(int) INTVAL (operands[2]));
    case 1:
      return xasprintf ("%s\t%s,%s # XD (volatile): insn src0, src1",
			arcv_apex_asm_mnemonic (operands[0], false),
			reg_names[REGNO (operands[1])],
...
(define_insn "riscv_arcv_apex_<APEX_DEST:mode>_ftype_v"
  ...
  ""
{
  return xasprintf ("%s\t%s # XD (volatile): insn rd",
...
(define_insn "riscv_arcv_apex_<APEX_DEST:mode>_ftype"
  ...
  ""
{
  return xasprintf ("%s\t%s # XD: insn rd",
		    arcv_apex_asm_mnemonic (operands[1], false),
		    reg_names[REGNO (operands[0])]);
}
  [(set_attr "type" "arith")]
  ...
  ""
{
  ...
  {
    case 0:
      return xasprintf ("%s\t%s,%d # XI (volatile): insn rd, src0",
			arcv_apex_asm_mnemonic (operands[1], true),
			reg_names[REGNO (operands[0])],
			(int) INTVAL (operands[2]));
    case 1:
      return xasprintf ("%s\t%s,%s # XD (volatile): insn rd, src0",
			arcv_apex_asm_mnemonic (operands[1], false),
			reg_names[REGNO (operands[0])],
			reg_names[REGNO (operands[2])]);
    default:
  ...
  ""
{
  ...
  {
    case 0:
      return xasprintf ("%s\t%s,%d # XI: insn rd, src0",
			arcv_apex_asm_mnemonic (operands[1], true),
			reg_names[REGNO (operands[0])],
			(int) INTVAL (operands[2]));
    case 1:
      return xasprintf ("%s\t%s,%s # XD: insn rd, src0",
			arcv_apex_asm_mnemonic (operands[1], false),
			reg_names[REGNO (operands[0])],
			reg_names[REGNO (operands[2])]);
    default:
  ...
  ""
{
  ...
  {
    case 0:
      return xasprintf ("%s\t%s,%s,%d # XS (volatile): insn rd, src0, imm/src1",
			arcv_apex_asm_mnemonic (operands[1], true),
			reg_names[REGNO (operands[0])],
			reg_names[REGNO (operands[2])],
			(int) INTVAL (operands[3]));
    case 1:
      return xasprintf ("%s\t%s,%s,%d # XC (volatile): insn rd/src0, imm",
			arcv_apex_asm_mnemonic (operands[1], true),
			reg_names[REGNO (operands[0])],
			reg_names[REGNO (operands[2])],
			(int) INTVAL (operands[3]));
    case 2:
      return xasprintf ("%s\t%s,%s,%s # XD (volatile): insn rd, src0, imm/src1",
			arcv_apex_asm_mnemonic (operands[1], false),
			reg_names[REGNO (operands[0])],
			reg_names[REGNO (operands[2])],
  ...
  ""
{
  ...
  {
    case 0:
      return xasprintf ("%s\t%s,%s,%d # XS: insn rd, src0, imm/src1",
			arcv_apex_asm_mnemonic (operands[1], true),
			reg_names[REGNO (operands[0])],
			reg_names[REGNO (operands[2])],
			(int) INTVAL (operands[3]));
    case 1:
      return xasprintf ("%s\t%s,%s,%d # XC: insn rd/src0, imm",
			arcv_apex_asm_mnemonic (operands[1], true),
			reg_names[REGNO (operands[0])],
			reg_names[REGNO (operands[2])],
			(int) INTVAL (operands[3]));
    case 2:
      return xasprintf ("%s\t%s,%s,%s # XD: insn rd, src0, imm/src1",
			arcv_apex_asm_mnemonic (operands[1], false),
			reg_names[REGNO (operands[0])],
			reg_names[REGNO (operands[2])],
			reg_names[REGNO (operands[3])]);
