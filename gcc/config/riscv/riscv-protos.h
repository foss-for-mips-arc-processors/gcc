...
enum riscv_fusion_pairs
{
  ...
  RISCV_FUSE_BFEXT_SRLI = (HOST_WIDE_INT_1U << 11),
  RISCV_FUSE_EXPANDED_LD = (HOST_WIDE_INT_1U << 12),
  RISCV_FUSE_B_ALUI = (HOST_WIDE_INT_1U << 13),
  RISCV_FUSE_MULT_ADD = (HOST_WIDE_INT_1U << 14),
  RISCV_FUSE_LI_BRANCH = (HOST_WIDE_INT_1U << 15),
  RISCV_FUSE_ADJACENT_LOAD = (HOST_WIDE_INT_1U << 16),
  RISCV_FUSE_ADJACENT_STORE = (HOST_WIDE_INT_1U << 17),
  RISCV_FUSE_LS_UPDATE = (HOST_WIDE_INT_1U << 18),
  RISCV_FUSE_LUI_ST = (HOST_WIDE_INT_1U << 19),
  RISCV_FUSE_LI_STORE = (HOST_WIDE_INT_1U << 20),
  RISCV_FUSE_LUI_LD_REV = (HOST_WIDE_INT_1U << 21),
  RISCV_FUSE_BFEXT_SRAI = (HOST_WIDE_INT_1U << 22),
};
