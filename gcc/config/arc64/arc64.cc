...
/* Implement TARGET_C_MODE_FOR_FLOATING_TYPE.  Return default:
   32-bit floats, and 64-bit doubles and long doubles.  */

static machine_mode
arc64_c_mode_for_floating_type (enum tree_index ti)
{
  ...
  if (arc64_is_long_call_p (temp0) && !REG_P (temp0))
    {
      ...
      /* Make use of R13_REGNUM to store the sibcall address.
	 This register is caller saved and can be used locally
...
#define TARGET_C_MODE_FOR_FLOATING_TYPE arc64_c_mode_for_floating_type
