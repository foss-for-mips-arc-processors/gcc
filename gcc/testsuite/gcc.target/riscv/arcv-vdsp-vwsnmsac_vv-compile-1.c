...
vint16m2_t
test_vwsnmsac_vv_i8_tu (vint16m2_t maskedoff, vint8m1_t vs1, vint8m1_t vs2, size_t vl)
{
  return __riscv_arcv_vwsnmsac_vv_i16m2_tu (maskedoff, vs1, vs2, vl);
}

/*
** test_vwsnmsac_vv_i8_tumu:
...
vint16m2_t
test_vwsnmsac_vv_i8_tumu (vbool8_t mask, vint16m2_t maskedoff, vint8m1_t vs1, vint8m1_t vs2, size_t vl)
{
  return __riscv_arcv_vwsnmsac_vv_i16m2_tumu (mask, maskedoff, vs1, vs2, vl);
}

/*
** test_vwsnmsac_vv_i8_mu:
...
vint16m2_t
test_vwsnmsac_vv_i8_mu (vbool8_t mask, vint16m2_t pass, vint8m1_t vs1, vint8m1_t vs2, size_t vl)
{
  return __riscv_arcv_vwsnmsac_vv_i16m2_mu (mask, pass, vs1, vs2, vl);
}
...
vint32m2_t
test_vwsnmsac_vv_i16_tu (vint32m2_t maskedoff, vint16m1_t vs1, vint16m1_t vs2, size_t vl)
{
  return __riscv_arcv_vwsnmsac_vv_i32m2_tu (maskedoff, vs1, vs2, vl);
}

/*
** test_vwsnmsac_vv_i16_tumu:
...
vint32m2_t
test_vwsnmsac_vv_i16_tumu (vbool16_t mask, vint32m2_t maskedoff, vint16m1_t vs1, vint16m1_t vs2, size_t vl)
{
  return __riscv_arcv_vwsnmsac_vv_i32m2_tumu (mask, maskedoff, vs1, vs2, vl);
}

/*
** test_vwsnmsac_vv_i16_mu:
...
vint32m2_t
test_vwsnmsac_vv_i16_mu (vbool16_t mask, vint32m2_t pass, vint16m1_t vs1, vint16m1_t vs2, size_t vl)
{
  return __riscv_arcv_vwsnmsac_vv_i32m2_mu (mask, pass, vs1, vs2, vl);
}
...
vint64m2_t
test_vwsnmsac_vv_i32_tu (vint64m2_t maskedoff, vint32m1_t vs1, vint32m1_t vs2, size_t vl)
{
  return __riscv_arcv_vwsnmsac_vv_i64m2_tu (maskedoff, vs1, vs2, vl);
}

/*
** test_vwsnmsac_vv_i32_tumu:
...
vint64m2_t
test_vwsnmsac_vv_i32_tumu (vbool32_t mask, vint64m2_t maskedoff, vint32m1_t vs1, vint32m1_t vs2, size_t vl)
{
  return __riscv_arcv_vwsnmsac_vv_i64m2_tumu (mask, maskedoff, vs1, vs2, vl);
}

/*
** test_vwsnmsac_vv_i32_mu:
...
vint64m2_t
test_vwsnmsac_vv_i32_mu (vbool32_t mask, vint64m2_t pass, vint32m1_t vs1, vint32m1_t vs2, size_t vl)
{
  return __riscv_arcv_vwsnmsac_vv_i64m2_mu (mask, pass, vs1, vs2, vl);
}
