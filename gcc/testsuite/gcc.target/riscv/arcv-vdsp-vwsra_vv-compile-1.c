...
vint16m2_t
test_vwsra_vv_i8_tu (vint16m2_t maskedoff, vint8m1_t vs2, vint8m1_t vs1, size_t vl)
{
  return __riscv_arcv_vwsra_vv_i16m2_tu (maskedoff, vs2, vs1, 0, vl);
}

/*
** test_vwsra_vv_i8_tumu:
**   csrwi\s+vxrm,0
...
vint16m2_t
test_vwsra_vv_i8_tumu (vbool8_t mask, vint16m2_t maskedoff, vint8m1_t vs2, vint8m1_t vs1, size_t vl)
{
  return __riscv_arcv_vwsra_vv_i16m2_tumu (mask, maskedoff, vs2, vs1, 0, vl);
}
...
vint16m2_t
test_vwsra_vv_i8_mu (vbool8_t mask, vint16m2_t pass, vint8m1_t vs2, vint8m1_t vs1, size_t vl)
{
  return __riscv_arcv_vwsra_vv_i16m2_mu (mask, pass, vs2, vs1, 0, vl);
}
...
vint32m2_t
test_vwsra_vv_i16_tu (vint32m2_t maskedoff, vint16m1_t vs2, vint16m1_t vs1, size_t vl)
{
  return __riscv_arcv_vwsra_vv_i32m2_tu (maskedoff, vs2, vs1, 0, vl);
}

/*
** test_vwsra_vv_i16_tumu:
**   csrwi\s+vxrm,0
...
vint32m2_t
test_vwsra_vv_i16_tumu (vbool16_t mask, vint32m2_t maskedoff, vint16m1_t vs2, vint16m1_t vs1, size_t vl)
{
  return __riscv_arcv_vwsra_vv_i32m2_tumu (mask, maskedoff, vs2, vs1, 0, vl);
}

/*
** test_vwsra_vv_i16_mu:
**   csrwi\s+vxrm,0
...
vint32m2_t
test_vwsra_vv_i16_mu (vbool16_t mask, vint32m2_t pass, vint16m1_t vs2, vint16m1_t vs1, size_t vl)
{
  return __riscv_arcv_vwsra_vv_i32m2_mu (mask, pass, vs2, vs1, 0, vl);
}
...
vint64m2_t
test_vwsra_vv_i32_tu (vint64m2_t maskedoff, vint32m1_t vs2, vint32m1_t vs1, size_t vl)
{
  return __riscv_arcv_vwsra_vv_i64m2_tu (maskedoff, vs2, vs1, 0, vl);
}

/*
** test_vwsra_vv_i32_tumu:
**   csrwi\s+vxrm,0
...
vint64m2_t
test_vwsra_vv_i32_tumu (vbool32_t mask, vint64m2_t maskedoff, vint32m1_t vs2, vint32m1_t vs1, size_t vl)
{
  return __riscv_arcv_vwsra_vv_i64m2_tumu (mask, maskedoff, vs2, vs1, 0, vl);
}

/*
** test_vwsra_vv_i32_mu:
**   csrwi\s+vxrm,0
...
vint64m2_t
test_vwsra_vv_i32_mu (vbool32_t mask, vint64m2_t pass, vint32m1_t vs2, vint32m1_t vs1, size_t vl)
{
  return __riscv_arcv_vwsra_vv_i64m2_mu (mask, pass, vs2, vs1, 0, vl);
}
