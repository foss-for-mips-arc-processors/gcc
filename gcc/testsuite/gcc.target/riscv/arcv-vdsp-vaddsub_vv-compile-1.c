...
{
  return __riscv_arcv_vaddsub_vv_i16m1_tu (maskedoff, vs2, vs1, vl);
}
...
{
  return __riscv_arcv_vaddsub_vv_i16m1_tumu (mask, maskedoff, vs2, vs1, vl);
}
...
{
  return __riscv_arcv_vaddsub_vv_i16m1_mu (mask, pass, vs2, vs1, vl);
}
...
{
  return __riscv_arcv_vaddsub_vv_i32m1_tu (maskedoff, vs2, vs1, vl);
}
...
{
  return __riscv_arcv_vaddsub_vv_i32m1_tumu (mask, maskedoff, vs2, vs1, vl);
}
...
{
  return __riscv_arcv_vaddsub_vv_i32m1_mu (mask, pass, vs2, vs1, vl);
}
...
{
  return __riscv_arcv_vaddsub_vv_i64m1_tu (maskedoff, vs2, vs1, vl);
}
...
{
  return __riscv_arcv_vaddsub_vv_i64m1_tumu (mask, maskedoff, vs2, vs1, vl);
}
...
{
  return __riscv_arcv_vaddsub_vv_i64m1_mu (mask, pass, vs2, vs1, vl);
}
