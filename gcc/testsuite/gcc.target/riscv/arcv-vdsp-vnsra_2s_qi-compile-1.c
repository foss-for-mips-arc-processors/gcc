...
vint8m1_t
test_vnsra_2s_qi_i8_tu (vint8m1_t maskedoff, vint32m1_t vs2, vint8m1_t vs1, size_t vl)
{
  return __riscv_arcv_vnsra_2s_qx_i8m1_tu (maskedoff, vs2, 1, 0, vl);
}

/*
** test_vnsra_2s_qi_i8_tumu:
**   csrwi\s+vxrm,0
...
vint8m1_t
test_vnsra_2s_qi_i8_tumu (vbool8_t mask, vint8m1_t maskedoff, vint32m1_t vs2, vint8m1_t vs1, size_t vl)
{
  return __riscv_arcv_vnsra_2s_qx_i8m1_tumu (mask, maskedoff, vs2, 1, 0, vl);
}

/*
** test_vnsra_2s_qi_i8_mu:
**   csrwi\s+vxrm,0
...
vint8m1_t
test_vnsra_2s_qi_i8_mu (vbool8_t mask, vint8m1_t pass, vint32m1_t vs2, vint8m1_t vs1, size_t vl)
{
  return __riscv_arcv_vnsra_2s_qx_i8m1_mu (mask, pass, vs2, 1, 0, vl);
}
...
vint16m1_t
test_vnsra_2s_qi_i16 (vint64m2_t vs2, vint16m1_t vs1, size_t vl)
{
...
vint16m1_t
test_vnsra_2s_qi_i16_m (vbool16_t mask, vint64m2_t vs2, vint16m1_t vs1, size_t vl)
{
  return __riscv_arcv_vnsra_2s_qx_i16m1_m (mask, vs2, 1, 0, vl);
}

/*
** test_vnsra_2s_qi_i16_tu:
**   csrwi\s+vxrm,0
...
vint16m1_t
test_vnsra_2s_qi_i16_tu (vint16m1_t maskedoff, vint64m2_t vs2, vint16m1_t vs1, size_t vl)
{
  return __riscv_arcv_vnsra_2s_qx_i16m1_tu (maskedoff, vs2, 1, 0, vl);
}

/*
** test_vnsra_2s_qi_i16_tumu:
**   csrwi\s+vxrm,0
...
vint16m1_t
test_vnsra_2s_qi_i16_tumu (vbool16_t mask, vint16m1_t maskedoff, vint64m2_t vs2, vint16m1_t vs1, size_t vl)
{
  return __riscv_arcv_vnsra_2s_qx_i16m1_tumu (mask, maskedoff, vs2, 1, 0, vl);
}

/*
** test_vnsra_2s_qi_i16_mu:
**   csrwi\s+vxrm,0
...
vint16m1_t
test_vnsra_2s_qi_i16_mu (vbool16_t mask, vint16m1_t pass, vint64m2_t vs2, vint16m1_t vs1, size_t vl)
{
  return __riscv_arcv_vnsra_2s_qx_i16m1_mu (mask, pass, vs2, 1, 0, vl);
}
