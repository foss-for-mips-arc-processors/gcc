...
**  ret
*/
vint16m1_t test_vconj_v_i16_tu (vint16m1_t maskedoff, vint16m1_t vs2, size_t vl)
{
  return __riscv_arcv_vconj_v_i16m1_tu (maskedoff, vs2, vl);
}

/*
** test_vconj_v_i16_tumu:
**  vsetvli\s+zero,\s*[a-x0-9]+,\s*e16,m1,\s*tu,\s*mu
**  arcv\.vconj\.v\s+(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1])\.t
**  ret
*/
vint16m1_t test_vconj_v_i16_tumu (vbool16_t mask, vint16m1_t maskedoff, vint16m1_t vs2, size_t vl)
{
  return __riscv_arcv_vconj_v_i16m1_tumu (mask, maskedoff, vs2, vl);
}
...
**  ret
*/
vint16m1_t test_vconj_v_i16_mu (vbool16_t mask, vint16m1_t pass, vint16m1_t vs2, size_t vl)
{
  return __riscv_arcv_vconj_v_i16m1_mu (mask, pass, vs2, vl);
}
...
**  ret
*/
vint32m1_t test_vconj_v_i32_tu (vint32m1_t maskedoff, vint32m1_t vs2, size_t vl)
{
  return __riscv_arcv_vconj_v_i32m1_tu (maskedoff, vs2, vl);
}

/*
** test_vconj_v_i32_tumu:
**  vsetvli\s+zero,\s*[a-x0-9]+,\s*e32,m1,\s*tu,\s*mu
**  arcv\.vconj\.v\s+(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1])\.t
**  ret
*/
vint32m1_t test_vconj_v_i32_tumu (vbool32_t mask, vint32m1_t maskedoff, vint32m1_t vs2, size_t vl)
{
  return __riscv_arcv_vconj_v_i32m1_tumu (mask, maskedoff, vs2, vl);
}
...
**  ret
*/
vint32m1_t test_vconj_v_i32_mu (vbool32_t mask, vint32m1_t pass, vint32m1_t vs2, size_t vl)
{
  return __riscv_arcv_vconj_v_i32m1_mu (mask, pass, vs2, vl);
}
