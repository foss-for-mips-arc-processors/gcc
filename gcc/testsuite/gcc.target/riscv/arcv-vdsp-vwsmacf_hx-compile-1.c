...
vint32m2_t
test_vwsmacf_hx_i16_tu (vint32m2_t maskedoff, int vs1, vint8mf2_t vs2, size_t vl)
{
  return __riscv_arcv_vwsmacf_hx_i32m2_tu (maskedoff, vs1, vs2, vl);
}

/*
** test_vwsmacf_hx_i16_tumu:
...
vint32m2_t
test_vwsmacf_hx_i16_tumu (vbool16_t mask, vint32m2_t maskedoff, int vs1, vint8mf2_t vs2, size_t vl)
{
  return __riscv_arcv_vwsmacf_hx_i32m2_tumu (mask, maskedoff, vs1, vs2, vl);
}

/*
** test_vwsmacf_hx_i16_mu:
...
vint32m2_t
test_vwsmacf_hx_i16_mu (vbool16_t mask, vint32m2_t pass, int vs1, vint8mf2_t vs2, size_t vl)
{
  return __riscv_arcv_vwsmacf_hx_i32m2_mu (mask, pass, vs1, vs2, vl);
}
...
vint64m2_t
test_vwsmacf_hx_i32_tu (vint64m2_t maskedoff, int vs1, vint16mf2_t vs2, size_t vl)
{
  return __riscv_arcv_vwsmacf_hx_i64m2_tu (maskedoff, vs1, vs2, vl);
}

/*
** test_vwsmacf_hx_i32_tumu:
...
vint64m2_t
test_vwsmacf_hx_i32_tumu (vbool32_t mask, vint64m2_t maskedoff, int vs1, vint16mf2_t vs2, size_t vl)
{
  return __riscv_arcv_vwsmacf_hx_i64m2_tumu (mask, maskedoff, vs1, vs2, vl);
}

/*
** test_vwsmacf_hx_i32_mu:
...
vint64m2_t
test_vwsmacf_hx_i32_mu (vbool32_t mask, vint64m2_t pass, int vs1, vint16mf2_t vs2, size_t vl)
{
  return __riscv_arcv_vwsmacf_hx_i64m2_mu (mask, pass, vs1, vs2, vl);
}
