/* Verify that the RHX-100 scheduler does not end a cycle in the middle of
   ...
   Group under test:
     FLL (fused adjacent-load pair) + FLL (fused adjacent-load pair)
