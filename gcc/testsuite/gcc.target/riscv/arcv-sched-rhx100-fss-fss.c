/* Verify that the RHX-100 scheduler does not end a cycle in the middle of
   ...
   Group under test:
     FSS (fused adjacent-store pair) + FSS (fused adjacent-store pair)
