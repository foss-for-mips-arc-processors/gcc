...
/*
** test_vqcjrdot_vv_i16_tu:
**  vsetvli\s+zero,\s*[a-x0-9]+,\s*e16,m1,\s*tu,\s*m[au]
**  arcv\.vqcjrdot\.vv\s+(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1])
**  ret
*/
vint64m1_t test_vqcjrdot_vv_i16_tu (vint64m1_t maskedoff, vint16m1_t vs1, vint16m1_t vs2, size_t vl)
{
  return __riscv_arcv_vqcjrdot_vv_i16m1_i64m1_tu (maskedoff, vs1, vs2, vl);
}

/*
** test_vqcjrdot_vv_i16_tumu:
**  vsetvli\s+zero,\s*[a-x0-9]+,\s*e16,m1,\s*tu,\s*mu
**  arcv\.vqcjrdot\.vv\s+(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1])\.t
**  ret
*/
vint64m1_t test_vqcjrdot_vv_i16_tumu (vbool16_t mask, vint64m1_t maskedoff, vint16m1_t vs1, vint16m1_t vs2, size_t vl)
{
  return __riscv_arcv_vqcjrdot_vv_i16m1_i64m1_tumu (mask, maskedoff, vs1, vs2, vl);
}

/*
** test_vqcjrdot_vv_i16_mu:
**  vsetvli\s+zero,\s*[a-x0-9]+,\s*e16,m1,\s*t[au],\s*mu
**  arcv\.vqcjrdot\.vv\s+(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1])\.t
**  ret
*/
vint64m1_t test_vqcjrdot_vv_i16_mu (vbool16_t mask, vint64m1_t pass, vint16m1_t vs1, vint16m1_t vs2, size_t vl)
{
  return __riscv_arcv_vqcjrdot_vv_i16m1_i64m1_mu (mask, pass, vs1, vs2, vl);
}
