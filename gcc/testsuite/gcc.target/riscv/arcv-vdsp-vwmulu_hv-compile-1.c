...
/*
** test_vwmulu_hv_u16_tu:
**  vsetvli\s+zero,\s*[a-x0-9]+,\s*e16,m1,\s*tu,\s*m[au]
**  arcv.vwmulu.hv\s+(?:v[0-9]|v[1-2][0-9]|v3[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|v3[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|v3[0-1])
**  ret
*/

vuint32m2_t
test_vwmulu_hv_u16_tu (vuint32m2_t maskedoff, vuint8mf2_t vs2, vuint16m1_t vs1, size_t vl)
{
  return __riscv_arcv_vwmulu_hv_u32m2_tu (maskedoff, vs2, vs1, vl);
}

/*
** test_vwmulu_hv_u16_tumu:
**  vsetvli\s+zero,\s*[a-x0-9]+,\s*e16,m1,\s*tu,\s*mu
**  arcv.vwmulu.hv\s+(?:v[0-9]|v[1-2][0-9]|v3[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|v3[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|v3[0-1]),\s*v0\.t
**  ret
*/

vuint32m2_t
test_vwmulu_hv_u16_tumu (vbool16_t mask, vuint32m2_t maskedoff, vuint8mf2_t vs2, vuint16m1_t vs1, size_t vl)
{
  return __riscv_arcv_vwmulu_hv_u32m2_tumu (mask, maskedoff, vs2, vs1, vl);
}

/*
** test_vwmulu_hv_u16_mu:
...
vuint32m2_t
test_vwmulu_hv_u16_mu (vbool16_t mask, vuint32m2_t pass, vuint8mf2_t vs2, vuint16m1_t vs1, size_t vl)
{
  return __riscv_arcv_vwmulu_hv_u32m2_mu (mask, pass, vs2, vs1, vl);
}
...
vuint64m2_t
test_vwmulu_hv_u32_tu (vuint64m2_t maskedoff, vuint16mf2_t vs2, vuint32m1_t vs1, size_t vl)
{
  return __riscv_arcv_vwmulu_hv_u64m2_tu (maskedoff, vs2, vs1, vl);
}

/*
** test_vwmulu_hv_u32_tumu:
...
vuint64m2_t
test_vwmulu_hv_u32_tumu (vbool32_t mask, vuint64m2_t maskedoff, vuint16mf2_t vs2, vuint32m1_t vs1, size_t vl)
{
  return __riscv_arcv_vwmulu_hv_u64m2_tumu (mask, maskedoff, vs2, vs1, vl);
}

/*
** test_vwmulu_hv_u32_mu:
...
vuint64m2_t
test_vwmulu_hv_u32_mu (vbool32_t mask, vuint64m2_t pass, vuint16mf2_t vs2, vuint32m1_t vs1, size_t vl)
{
  return __riscv_arcv_vwmulu_hv_u64m2_mu (mask, pass, vs2, vs1, vl);
}
