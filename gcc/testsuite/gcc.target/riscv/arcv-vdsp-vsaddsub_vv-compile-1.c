...
{
  vint16m1_t a = __riscv_vsadd_vv_i16m1 (vs2, vs1, vl);
  vint16m1_t b = __riscv_vssub_vv_i16m1 (vs2, vs1, vl);
...
{
  vint16m1_t a = __riscv_vsadd_vv_i16m1_m (mask, vs2, vs1, vl);
  vint16m1_t b = __riscv_vssub_vv_i16m1_m (mask, vs2, vs1, vl);
...
{
  vint16m1_t a = __riscv_vsadd_vv_i16m1_tu (maskedoff, vs2, vs1, vl);
  vint16m1_t b = __riscv_vssub_vv_i16m1_tu (maskedoff, vs2, vs1, vl);
...
{
  vint16m1_t a = __riscv_vsadd_vv_i16m1_tumu (mask, maskedoff, vs2, vs1, vl);
  vint16m1_t b = __riscv_vssub_vv_i16m1_tumu (mask, maskedoff, vs2, vs1, vl);
...
{
  vint16m1_t a = __riscv_vsadd_vv_i16m1_mu (mask, pass, vs2, vs1, vl);
  vint16m1_t b = __riscv_vssub_vv_i16m1_mu (mask, pass, vs2, vs1, vl);
...
{
  vint32m1_t a = __riscv_vsadd_vv_i32m1 (vs2, vs1, vl);
  vint32m1_t b = __riscv_vssub_vv_i32m1 (vs2, vs1, vl);
...
{
  vint32m1_t a = __riscv_vsadd_vv_i32m1_m (mask, vs2, vs1, vl);
  vint32m1_t b = __riscv_vssub_vv_i32m1_m (mask, vs2, vs1, vl);
...
{
  vint32m1_t a = __riscv_vsadd_vv_i32m1_tu (maskedoff, vs2, vs1, vl);
  vint32m1_t b = __riscv_vssub_vv_i32m1_tu (maskedoff, vs2, vs1, vl);
...
{
  vint32m1_t a = __riscv_vsadd_vv_i32m1_tumu (mask, maskedoff, vs2, vs1, vl);
  vint32m1_t b = __riscv_vssub_vv_i32m1_tumu (mask, maskedoff, vs2, vs1, vl);
...
{
  vint32m1_t a = __riscv_vsadd_vv_i32m1_mu (mask, pass, vs2, vs1, vl);
  vint32m1_t b = __riscv_vssub_vv_i32m1_mu (mask, pass, vs2, vs1, vl);
...
{
  vint64m1_t a = __riscv_vsadd_vv_i64m1 (vs2, vs1, vl);
  vint64m1_t b = __riscv_vssub_vv_i64m1 (vs2, vs1, vl);
...
{
  vint64m1_t a = __riscv_vsadd_vv_i64m1_m (mask, vs2, vs1, vl);
  vint64m1_t b = __riscv_vssub_vv_i64m1_m (mask, vs2, vs1, vl);
...
{
  vint64m1_t a = __riscv_vsadd_vv_i64m1_tu (maskedoff, vs2, vs1, vl);
  vint64m1_t b = __riscv_vssub_vv_i64m1_tu (maskedoff, vs2, vs1, vl);
...
{
  vint64m1_t a = __riscv_vsadd_vv_i64m1_tumu (mask, maskedoff, vs2, vs1, vl);
  vint64m1_t b = __riscv_vssub_vv_i64m1_tumu (mask, maskedoff, vs2, vs1, vl);
...
{
  vint64m1_t a = __riscv_vsadd_vv_i64m1_mu (mask, pass, vs2, vs1, vl);
  vint64m1_t b = __riscv_vssub_vv_i64m1_mu (mask, pass, vs2, vs1, vl);
