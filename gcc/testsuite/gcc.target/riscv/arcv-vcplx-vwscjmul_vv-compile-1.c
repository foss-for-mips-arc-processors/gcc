...
/*
** test_vwscjmul_vv_i16_tu:
**  vsetvli\s+zero,\s*[a-x0-9]+,\s*e16,m1,\s*tu,\s*m[au]
**  arcv.vwscjmul.vv\s+(?:v[0-9]|v[1-2][0-9]|v3[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|v3[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|v3[0-1])
**  ret
*/

vint32m2_t
test_vwscjmul_vv_i16_tu (vint32m2_t maskedoff, vint16m1_t vs2, vint16m1_t vs1, size_t vl)
{
  return __riscv_arcv_vwscjmul_vv_i32m2_tu (maskedoff, vs2, vs1, vl);
}

/*
** test_vwscjmul_vv_i16_tumu:
**  vsetvli\s+zero,\s*[a-x0-9]+,\s*e16,m1,\s*tu,\s*mu
**  arcv.vwscjmul.vv\s+(?:v[0-9]|v[1-2][0-9]|v3[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|v3[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|v3[0-1]),\s*v0\.t
**  ret
*/

vint32m2_t
test_vwscjmul_vv_i16_tumu (vbool16_t mask, vint32m2_t maskedoff, vint16m1_t vs2, vint16m1_t vs1, size_t vl)
{
  return __riscv_arcv_vwscjmul_vv_i32m2_tumu (mask, maskedoff, vs2, vs1, vl);
}

/*
** test_vwscjmul_vv_i16_mu:
...
vint32m2_t
test_vwscjmul_vv_i16_mu (vbool16_t mask, vint32m2_t pass, vint16m1_t vs2, vint16m1_t vs1, size_t vl)
{
  return __riscv_arcv_vwscjmul_vv_i32m2_mu (mask, pass, vs2, vs1, vl);
}
...
vint64m2_t
test_vwscjmul_vv_i32_tu (vint64m2_t maskedoff, vint32m1_t vs2, vint32m1_t vs1, size_t vl)
{
  return __riscv_arcv_vwscjmul_vv_i64m2_tu (maskedoff, vs2, vs1, vl);
}

/*
** test_vwscjmul_vv_i32_tumu:
...
vint64m2_t
test_vwscjmul_vv_i32_tumu (vbool32_t mask, vint64m2_t maskedoff, vint32m1_t vs2, vint32m1_t vs1, size_t vl)
{
  return __riscv_arcv_vwscjmul_vv_i64m2_tumu (mask, maskedoff, vs2, vs1, vl);
}

/*
** test_vwscjmul_vv_i32_mu:
...
vint64m2_t
test_vwscjmul_vv_i32_mu (vbool32_t mask, vint64m2_t pass, vint32m1_t vs2, vint32m1_t vs1, size_t vl)
{
  return __riscv_arcv_vwscjmul_vv_i64m2_mu (mask, pass, vs2, vs1, vl);
}
