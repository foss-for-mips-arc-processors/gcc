...
vint8m1_t test_vsrat_vx_i8_tu (vint8m1_t maskedoff, vint8m1_t vs2, int vs1, size_t vl)
{
  return __riscv_arcv_vsrat_vx_i8m1_tu (maskedoff, vs2, vs1, vl);
}

/*
** test_vsrat_vx_i8_tumu:
**  vsetvli\s+zero,\s*[a-x0-9]+,\s*e8,m1,\s*t[au],\s*m[au]
**  arcv\.vsrat\.vx\s+(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1]),\s*[a-x0-9]+,\s*(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1])\.t
**  ret
*/

vint8m1_t test_vsrat_vx_i8_tumu (vbool8_t mask, vint8m1_t maskedoff, vint8m1_t vs2, int vs1, size_t vl)
{
  return __riscv_arcv_vsrat_vx_i8m1_tumu (mask, maskedoff, vs2, vs1, vl);
}
...
vint8m1_t test_vsrat_vx_i8_mu (vbool8_t mask, vint8m1_t pass, vint8m1_t vs2, int vs1, size_t vl)
{
  return __riscv_arcv_vsrat_vx_i8m1_mu (mask, pass, vs2, vs1, vl);
}
...
/*
** test_vsrat_vx_i16_tu:
**  vsetvli\s+zero,\s*[a-x0-9]+,\s*e16,m1,\s*t[au],\s*m[au]
**  arcv\.vsrat\.vx\s+(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1]),\s*[a-x0-9]+
**  ret
*/

vint16m1_t test_vsrat_vx_i16_tu (vint16m1_t maskedoff, vint16m1_t vs2, int vs1, size_t vl)
{
  return __riscv_arcv_vsrat_vx_i16m1_tu (maskedoff, vs2, vs1, vl);
}

/*
** test_vsrat_vx_i16_tumu:
**  vsetvli\s+zero,\s*[a-x0-9]+,\s*e16,m1,\s*t[au],\s*m[au]
**  arcv\.vsrat\.vx\s+(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1]),\s*[a-x0-9]+,\s*(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1])\.t
**  ret
*/

vint16m1_t test_vsrat_vx_i16_tumu (vbool16_t mask, vint16m1_t maskedoff, vint16m1_t vs2, int vs1, size_t vl)
{
  return __riscv_arcv_vsrat_vx_i16m1_tumu (mask, maskedoff, vs2, vs1, vl);
}

/*
** test_vsrat_vx_i16_mu:
**  vsetvli\s+zero,\s*[a-x0-9]+,\s*e16,m1,\s*t[au],\s*m[au]
**  arcv\.vsrat\.vx\s+(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1]),\s*[a-x0-9]+,\s*(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1])\.t
**  ret
*/

vint16m1_t test_vsrat_vx_i16_mu (vbool16_t mask, vint16m1_t pass, vint16m1_t vs2, int vs1, size_t vl)
{
  return __riscv_arcv_vsrat_vx_i16m1_mu (mask, pass, vs2, vs1, vl);
}
...
/*
** test_vsrat_vx_i32_tu:
**  vsetvli\s+zero,\s*[a-x0-9]+,\s*e32,m1,\s*t[au],\s*m[au]
**  arcv\.vsrat\.vx\s+(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1]),\s*[a-x0-9]+
**  ret
*/

vint32m1_t test_vsrat_vx_i32_tu (vint32m1_t maskedoff, vint32m1_t vs2, int vs1, size_t vl)
{
  return __riscv_arcv_vsrat_vx_i32m1_tu (maskedoff, vs2, vs1, vl);
}

/*
** test_vsrat_vx_i32_tumu:
**  vsetvli\s+zero,\s*[a-x0-9]+,\s*e32,m1,\s*t[au],\s*m[au]
**  arcv\.vsrat\.vx\s+(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1]),\s*[a-x0-9]+,\s*(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1])\.t
**  ret
*/

vint32m1_t test_vsrat_vx_i32_tumu (vbool32_t mask, vint32m1_t maskedoff, vint32m1_t vs2, int vs1, size_t vl)
{
  return __riscv_arcv_vsrat_vx_i32m1_tumu (mask, maskedoff, vs2, vs1, vl);
}

/*
** test_vsrat_vx_i32_mu:
**  vsetvli\s+zero,\s*[a-x0-9]+,\s*e32,m1,\s*t[au],\s*m[au]
**  arcv\.vsrat\.vx\s+(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1]),\s*(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1]),\s*[a-x0-9]+,\s*(?:v[0-9]|v[1-2][0-9]|[a-x0-9]+[0-1])\.t
**  ret
*/

vint32m1_t test_vsrat_vx_i32_mu (vbool32_t mask, vint32m1_t pass, vint32m1_t vs2, int vs1, size_t vl)
{
  return __riscv_arcv_vsrat_vx_i32m1_mu (mask, pass, vs2, vs1, vl);
}
...
{
  return __riscv_arcv_vsrat_vx_i64m1_tu (maskedoff, vs2, vs1, vl);
}
...
{
  return __riscv_arcv_vsrat_vx_i64m1_tumu (mask, maskedoff, vs2, vs1, vl);
}
...
{
  return __riscv_arcv_vsrat_vx_i64m1_mu (mask, pass, vs2, vs1, vl);
}
